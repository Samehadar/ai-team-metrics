...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'dateRange.ytd': 'YTD',
    'dateRange.days': '{0} days',
    'dateRange.reset': 'Reset',
    'dateRange.done': 'Done',
    'dateRange.customTooltip': 'Click to set a custom range',
    'dateRange.dataRangeHint': 'Data: {0} → {1}',
    ...
    'byTeam.kpiPlanUsage': 'Plan usage (avg)',
    'plan.title': 'Plan usage',
    'plan.unlimited': 'unlimited',
    'plan.snapshot': 'snapshot',
    'plan.totalPctLabel': 'of included total',
    'plan.apiPctLabel': 'of API limit',
    'plan.usageLabel': 'used / limit',
    'plan.remainingN': '{0} remaining',
  ...
  ru: {
    ...
    'dateRange.ytd': 'С начала года',
    'dateRange.days': '{0} дн',
    'dateRange.reset': 'Сбросить',
    'dateRange.done': 'Готово',
    'dateRange.customTooltip': 'Кликни для произвольного диапазона',
    'dateRange.dataRangeHint': 'Данные: {0} → {1}',
    ...
    'byTeam.kpiPlanUsage': 'Использование плана (среднее)',
    'plan.title': 'Использование плана',
    'plan.unlimited': 'без лимита',
    'plan.snapshot': 'снимок',
    'plan.totalPctLabel': 'от общего лимита',
    'plan.apiPctLabel': 'от API-лимита',
    'plan.usageLabel': 'использовано / лимит',
    'plan.remainingN': 'осталось {0}',
    'plan.cycle': 'биллинг',
